...
const [state, setState] = useState({
  series: [
    {
      name: "Previous Feedbacks",
      data: [23, 11, 22, 27, 13, 22, 37, 21, 44, 22, 30, 45],
    },
    {
      name: "Current Feedbacks",
        ...
        <div className="flex w-full flex-wrap gap-3 sm:gap-5">
          <div className="flex min-w-47.5">
            ...
            <div className="w-full">
              ...
              <p className="text-sm font-medium">1884</p>
            </div>
          </div>
          <div className="flex min-w-47.5">
            ...
            <div className="w-full">
              <p className="font-semibold text-secondary">Total Positive feedbacks</p>
              <p className="text-sm font-medium">1062</p>
            </div>
          </div>
        </div>
