...
import TableOne from './Chart/TableOne';
import ChatCard from './Chart/ChatCard';
  ...
  return (
    <div className='flex justify-center items-center w-screen'>
      <div className="w-[80vw]">
        ...
        <div className="mt-4 grid grid-cols-12 gap-4 md:mt-6 md:gap-6 2xl:mt-7.5 2xl:gap-7.5 mb-10">
          <ChartOne />
          <ChartTwo />
